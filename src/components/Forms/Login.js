        ...
        <div className="relative container px-4 mx-auto">
          <div className="max-w-xl mx-auto py-10 px-8 sm:px-20 bg-white rounded-md">
            <div className="mb-6">
              ...
              {userAuth?.error && <h2 className='text-center text-red-500'>{userAuth?.error?.message}</h2>}
            </div>
            <form onSubmit={onSubmitHandler}>
              ...
              <div className="text-right mb-6">
               {loading ? ( <button
                  className="block w-full py-4 px-6 text-center font-heading font-medium text-base text-white bg-gray-400 hover:bg-green-600 border border-green-500 hover:border-green-600 rounded-sm transition duration-200"
                  type="submit"
                >
                  loading...
                </button>) : ( <button
